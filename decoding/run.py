...
def decode_answers(answers_df, lemmatize, parallel, keep_duplicates_per_concept):
    decoded_rows = []
    rules_changes = []
...
def run_decode(args):
    ...
    decoded_answers_df, rule_changes = decode_answers(answers, lemmatize, parallel, keep_duplicates_per_concept)
    decoded_answers_df = find_synonyms(decoded_answers_df, output_dir)
