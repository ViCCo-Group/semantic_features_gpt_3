...
def load_gpt(min_amount_runs_feature_occured, group_to_one_concept, min_amount_runs_feature_occured_within_concept, duplicates, priming, model, number_runs, concepts):
    # Read GPT3 features
    gpt_df = pd.read_csv(f'{DATA_DIR}/gpt_3_feature_norm/{priming}/{model}/{concepts}/{number_runs}/decoded_answers.csv')
